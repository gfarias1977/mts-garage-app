...
import { getServiceCategories, type SortColumn } from '@/data/serviceCategories';
import { ServiceCategoriesModule } from '@/components/service-categories/ServiceCategoriesModule';
...
export default async function ServiceCategoriesPage({ searchParams }: { searchParams: SP }) {
  ...
  const result = await getServiceCategories({ userId: user.id, search, sortBy, sortDir, page, pageSize });
